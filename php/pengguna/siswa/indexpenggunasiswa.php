...
$query = "SELECT tb_user_siswa.nisn, tb_siswa.nama_siswa, tb_user_siswa.username, tb_user_siswa.password FROM tb_user_siswa JOIN tb_siswa on tb_user_siswa.nisn = tb_siswa.nisn;";
...
<head>
    ...
    <title>Pengguna Siswa - Reporthing</title>
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="pages" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
                            ...
                            <li class="sidebar-item">
                                <a href="indexpenggunasiswa.php" class="sidebar-link active">
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="content-fluid">
                    <div class="mb-3">
                        <h4>Pengguna Siswa</h4>
                        <h6>Halaman untuk mengelola pengguna siswa</h6>
                    </div>
