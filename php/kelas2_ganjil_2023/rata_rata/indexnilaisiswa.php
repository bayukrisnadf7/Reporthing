...
$query = "SELECT tb_siswa.nisn, tb_siswa.nama_siswa, tb_total_nilai.* from tb_total_nilai join tb_siswa on tb_total_nilai.nisn = tb_siswa.nisn join tb_tahunajaran on tb_tahunajaran.id_tahunajaran = tb_total_nilai.id_tahunajaran where tb_siswa.id_kelas = 7 AND tb_total_nilai.id_tahunajaran = 14 ;";
