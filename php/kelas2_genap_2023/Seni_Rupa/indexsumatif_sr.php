...
<head>
    ...
    <title>Seni Rupa - Reporthing</title>
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="content-fluid">
                    <div class="mb-3">
                        <h4>Mata Pelajaran Seni Rupa</h4>
                ...
                <div class="card border-0">
                    <div class="card-header" style="background-color: #FFFFFF;">
                        <a href="tambah_sr.php" type="button" class="btn btn-primary btn-sm">
                                ...
                                <tbody>
                                    ...
                                    while ($result = mysqli_fetch_assoc($sql)) {
                                        ...
                                        <td>
                                            ...
                                            <!-- <a href="proses_sr.php?hapus=<?php
                                            echo $result['nisn'];
