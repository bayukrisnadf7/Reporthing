...
<head>
    ...
    <title>Bahasa Indonesia - Reporthing</title>
    <!-- Bootstrap -->
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="content-fluid">
                    <div class="mb-3">
                        <h4>Mata Pelajaran Bahasa Indonesia</h4>
                ...
                <div class="card border-0">
                    <div class="card-header" style="background-color: #FFFFFF;">
                        <a href="tambah_bi.php" type="button" class="btn btn-primary btn-sm">
                            ...
                            <table id="dt" class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    while ($result = mysqli_fetch_assoc($sql)) {
                                        ...
                                        <td>
                                            <a href="edit_bi.php?ubah=<?php
                                            echo $result['nisn'];
                                            ?>" type="button" class="btn btn-warning btn-sm">
                                                <i class="fa fa-pen"></i>
                                            </a>
                                            <a href="proses_bi.php?hapus=<?php
                                            echo $result['nisn'];
