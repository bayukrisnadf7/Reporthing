...
$result4 = mysqli_query($conn, "SELECT * FROM tb_tahunajaran where id_tahunajaran = 15");
$row = mysqli_fetch_assoc($result4);
$semester = $row['semester'];
$tahun_ajaran = $row['tahun_ajaran'];


$query = "SELECT tb_siswa.nisn, tb_siswa.nama_siswa, tb_total_nilai.rata_rata from tb_total_nilai join tb_siswa on tb_total_nilai.nisn = tb_siswa.nisn where tb_total_nilai.id_tahunajaran = 15 and tb_total_nilai.id_kelas = 7 order by rata_rata desc;";
