...
<head>
    ...
    <title>Tambah Nilai Seni Teater - Reporthing</title>
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul id="pages" class="sidebar-dropdown list-unstyled collapse show"
                                ...
                                <li class="sidebar-item">
                                    <a href="indexsumatif_st2.php" class="sidebar-link active">
                        ...
                        <div class="card-header" style="background-color: #FFFFFF;">
                            ...
                            if (isset($_GET['ubah'])) {
                                ...
                                <h6 name="aksi" value="add" class="card-tittle mt-2" style="color: black;">
                                    <i class="fas fa-plus"></i> Tambah Data Nilai Seni Teater
                                </h6>
