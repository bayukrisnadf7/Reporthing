...
$query2 = "SELECT id_mapel, nama_mapel FROM tb_mapel WHERE id_mapel = 9";
...
<head>
    ...
    <title>Tambah Nilai Bahasa Inggris - Reporthing</title>
                        ...
                        <div class="card-header" style="background-color: #FFFFFF;">
                            ...
                            if (isset($_GET['ubah'])) {
                                ...
                                <h6 name="aksi" value="add" class="card-tittle mt-2" style="color: black;">
                                    <i class="fas fa-plus"></i> Tambah Data Nilai Bahasa Inggris
                                </h6>
