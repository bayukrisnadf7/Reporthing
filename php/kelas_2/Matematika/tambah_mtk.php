...
$sql1 = "SELECT nisn,nama_siswa FROM tb_siswa WHERE id_kelas = 7 AND id_tahunajaran = 12";
$query2 = "SELECT id_mapel, nama_mapel FROM tb_mapel WHERE id_mapel = 2";
$query3 = "SELECT id_tahunajaran, tahun_ajaran FROM tb_tahunajaran where id_tahunajaran = 12"; 
...
<head>
    ...
    <title>Tambah Nilai Matematika - Reporthing</title>
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul id="pages" class="sidebar-dropdown list-unstyled collapse show"
                                ...
                                <li class="sidebar-item">
                                    <a href="indexsumatif_mtk.php" class="sidebar-link active">
            ...
            <main class="content px-3 py-2">
                <div class="content-fluid">
                    ...
                    <div class="card border-0">
                        <div class="card-header" style="background-color: #FFFFFF;">
                            ...
                            if (isset($_GET['ubah'])) {
                                ...
                                <h6 name="aksi" value="edit" class="card-tittle mt-2" style="color: black;">
                                    <i class="fa fa-pen"></i> Edit Data Nilai Matematika
                                </h6>
                                ...
                                <h6 name="aksi" value="add" class="card-tittle mt-2" style="color: black;">
                                    <i class="fas fa-plus"></i> Tambah Data Nilai Matematika
                                </h6>
                        ...
                        <div class="card-body">
                            <div class="container">
                                <form method="POST" action="proses_mtk.php" enctype="multipart/form-data" name="autosumForm">
                                    ...
                                    <div class="mb-3 row mt-4">
                                        <div class="col">
                                            ...
                                            ?>
                                            <a href="indexsumatif_mtk.php" type="button" class="btn btn-danger btn-sm">
