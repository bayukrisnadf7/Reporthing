...
$query2 = "SELECT id_mapel, nama_mapel FROM tb_mapel WHERE id_mapel = 8";
...
<head>
    ...
    <title>Tambah Nilai PJOK - Reporthing</title>
            ...
            <main class="content px-3 py-2">
                <div class="content-fluid">
                    ...
                    <div class="card border-0">
                        <div class="card-header" style="background-color: #FFFFFF;">
                            ...
                            if (isset($_GET['ubah'])) {
                                ...
                                <h6 name="aksi" value="add" class="card-tittle mt-2" style="color: black;">
                                    <i class="fas fa-plus"></i> Tambah Data Nilai PJOK
                                </h6>
                        ...
                        <div class="card-body">
                            <div class="container">
                                <form method="POST" action="proses_pjok.php" enctype="multipart/form-data" name="autosumForm">
                                    ...
                                    <div class="mb-3 row mt-4">
                                        <div class="col">
                                            ...
                                            ?>
                                            <a href="indexsumatif_pjok.php" type="button" class="btn btn-danger btn-sm">
