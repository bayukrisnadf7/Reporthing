...
$query2 = "SELECT id_mapel, nama_mapel FROM tb_mapel WHERE id_mapel = 5";
...
<head>
    ...
    <title>Tambah Nilai Seni Tari - Reporthing</title>
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul id="pages" class="sidebar-dropdown list-unstyled collapse show"
                                ...
                                <li class="sidebar-item">
                                    <a href="indexsumatif_st.php" class="sidebar-link active">
            ...
            <main class="content px-3 py-2">
                <div class="content-fluid">
                    ...
                    <div class="card border-0">
                        <div class="card-header" style="background-color: #FFFFFF;">
                            ...
                            if (isset($_GET['ubah'])) {
                                ...
                                <h6 name="aksi" value="add" class="card-tittle mt-2" style="color: black;">
                                    <i class="fas fa-plus"></i> Tambah Data Nilai Seni Tari
                                </h6>
                        ...
                        <div class="card-body">
                            <div class="container">
                                <form method="POST" action="proses_st.php" enctype="multipart/form-data" name="autosumForm">
