...
$query2 = "SELECT id_mapel, nama_mapel FROM tb_mapel WHERE id_mapel = 4";
...
<head>
    ...
    <title>Tambah Nilai Seni Musik - Reporthing</title>
                        ...
                        <div class="card-header" style="background-color: #FFFFFF;">
                            ...
                            if (isset($_GET['ubah'])) {
                                ...
                                <h6 name="aksi" value="add" class="card-tittle mt-2" style="color: black;">
                                    <i class="fas fa-plus"></i> Tambah Data Nilai Seni Musik
                                </h6>
