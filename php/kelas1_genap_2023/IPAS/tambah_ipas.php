            ...
            <main class="content px-3 py-2">
                <div class="content-fluid">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <form method="POST" action="proses_ipas.php" enctype="multipart/form-data"
                                    name="autosumForm">
