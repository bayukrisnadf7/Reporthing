            ...
            <main class="content px-3 py-2">
                ...
                <div class="card border-0">
                    <div class="card-header" style="background-color: #FFFFFF;">
                        <a href="tambah_ipas.php" type="button" class="btn btn-primary btn-sm">
