...
<head>
    ...
    <title>Tahun Ajaran - Reporthing</title>
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="content-fluid">
                    <div class="mb-3">
                        <h4>Data Tahun Ajaran Siswa</h4>
                        <h6>Halaman untuk mengelola data tahun ajaran siswa</h6>
                    </div>
                    ...
                    <div class="card border-0">
                        <div class="card-header" style="background-color: #FFFFFF;">
                            <a href="kelolaajaran.php" type="button" class="btn btn-primary btn-sm">
                                ...
                                <table id="dt" class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        while ($result = mysqli_fetch_assoc($sql)) {
                                            ...
                                            <td>
                                                <a href="kelolaajaran.php?ubah=<?php echo $result['id_tahunajaran']; ?>"
                                                    type="button" class="btn btn-warning btn-sm">
                                                    <i class="fa fa-pen"></i>
                                                </a>
                                                <a href="prosesajaran.php?hapus=<?php echo $result['id_tahunajaran']; ?>"
