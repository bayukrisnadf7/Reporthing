<?php
    ...
    function tambah_data($data){
        ...
        $query = "INSERT INTO tb_tahunajaran VALUES(null, '$tahun_ajaran')";
    ...
    function ubah_data($data){
        ...
        $query = "UPDATE tb_tahunajaran SET tahun_ajaran='$tahun_ajaran' WHERE id_tahunajaran='$id_tahunajaran';";
        $sql = mysqli_query($GLOBALS['conn'], $query);
