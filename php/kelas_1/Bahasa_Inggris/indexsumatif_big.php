                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul id="pages" class="sidebar-dropdown list-unstyled collapse show"
                                ...
                                <li class="sidebar-item">
                                    <a href="Bahasa_Inggris/indexsumatif_big.php" class="sidebar-link active">
            ...
            <main class="content px-3 py-2">
                ...
                <div class="card border-0">
                    <div class="card-header" style="background-color: #FFFFFF;">
                        <a href="tambah_big.php" type="button" class="btn btn-primary btn-sm">
                            ...
                            <table id="dt" class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    while ($result = mysqli_fetch_assoc($sql)) {
                                        ...
                                        <td>
                                            <a href="edit_big.php?ubah=<?php
                                            echo $result['nisn'];
                                            ?>" type="button" class="btn btn-warning btn-sm">
                                                <i class="fa fa-pen"></i>
                                            </a>
                                            <a href="proses_big.php?hapus=<?php
                                            echo $result['nisn'];
