...
function tambah_data($data)
{
    ...
    $query = "UPDATE tb_total_nilai SET ipas = '$nilai_rapor' WHERE nisn='$nisn' AND id_tahunajaran = 12;";
    $sql = mysqli_query($GLOBALS['conn'], $query);
...
function hapus_data($data)
{
    ...
    $queryShow = "SELECT * FROM tb_nilai WHERE nisn = '$nisn' AND id_tahunajaran = 12;";
    $sqlShow = mysqli_query($GLOBALS['conn'], $queryShow);
    $result = mysqli_fetch_assoc($sqlShow);

    $query = "UPDATE tb_total_nilai SET ipas = 0 WHERE nisn='$nisn' AND id_tahunajaran = 12;";
    $sql = mysqli_query($GLOBALS['conn'], $query);
