                                ...
                                <table id="dt" class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        while ($result = mysqli_fetch_assoc($sql)) {
                                            ...
                                            <td>
                                                <a href="kelola_ipas.php?ubah=<?php echo $result['nisn']; ?>"
                                                    type="button" class="btn btn-warning btn-sm">
                                                    <i class="fa fa-pen"></i>
                                                </a>
                                                <a href="proses_ipas.php?hapus=<?php echo $result['id_kelas']; ?>"
