...
function tambah_data($data)
{
    ...
    $query = "UPDATE tb_total_nilai SET seni_teater = '$nilai_rapor' WHERE nisn='$nisn' AND id_tahunajaran = 12;";
    $sql = mysqli_query($GLOBALS['conn'], $query);
...
function hapus_data($data)
{
    ...
    $query = "UPDATE tb_total_nilai SET seni_teater = 0 WHERE nisn='$nisn' AND id_tahunajaran = 12;";
    $sql = mysqli_query($GLOBALS['conn'], $query);
    return true;
}
