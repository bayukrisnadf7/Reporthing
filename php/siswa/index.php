        ...
        <tbody>
          ...
          while ($result = mysqli_fetch_assoc($sql)) {
            ...
            <tr>
              ...
              <td>
                <center>
                  <a href="kelola.php?edit=<?php echo $result['id_siswa']; ?>" type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#UbahSiswa<?= $no?>"><i class="fa fa-pencil"></i></a>
                  <a href="proses.php?hapus=<?php echo $result['id_siswa']; ?>" type="button"class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#HapusSiswa"><i ><i class="fa fa-trash"></i></a>
                </center>
              </td>
            </tr>

            <!-- awal modal ubah -->
    <div class="modal fade modal-lg" id="UbahSiswa<?= $no?>" data-bs-backdrop="static" data-bs-keyboard="false"
      tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            <form method="POST" action="proses.php" enctype="multipart/form-data">
              <input type="hidden" value="<?php echo $result['id_siswa']; ?>" name="id_siswa">
              <div class="mb-3 row">
                <label for="nisn" class="col-sm-2 col-form-label mt-4">
                  NISN
                </label>
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  ...
                  $result1 = $conn->query($sql1);
                    ...
                    if ($result1->num_rows > 0) {
                      while ($row = $result1->fetch_assoc()) {
                        $selected = ($row['id_kelas'] == $result['id_kelas']) ? "selected" : "";
                        echo "<option $selected value='" . $row['id_kelas'] . "'>" . $row["nama_kelas"] . "</option>";
                      }
                    } else {
                      echo "0 hasil";
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input required type="text" name="tempat_lahir" class="form-control" id="tempat_lahir"
                    placeholder="Ex: Jember" value="<?= $result['tempat_lahir']; ?>">
                </div>
              </div>
              <div class="mb-3 row">
                <label for="tanggal_lahir" class="col-sm-2 col-form-label">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input required type="text" name="no_telp" class="form-control" id="notelp"
                    placeholder="Ex: 085XXXXXXXXX" value="<?= $result['no_telp']; ?>">
                </div>
              </div>
              <div class="mb-3 row">
                <label for="jkel" class="col-sm-2 col-form-label">
                ...
                <div class="col-sm-10">
                  <select required id="jkel" name="jenis_kelamin" class="form-select" >
                    <option <?php if ($result['jenis_kelamin'] == 'Laki-laki') {
                      echo "selected";
                    } ?> value="Laki-laki">Laki-laki
                    </option>
                    <option <?php if ($result['jenis_kelamin'] == 'Perempuan') {
                      echo "selected";
                    } ?> value="Perempuan">Perempuan
                    </option>
                  </select>
